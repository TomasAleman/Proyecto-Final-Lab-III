...
public class Main {
	...
	public static void main(String[] args) {
		...
		Serie serie1 = new Serie("Stranger Things", 2, Genero.SUSPENSO, Clasificacion.MAS13, "Cuando un niño desaparece, sus amigos, la familia y la policía se ven envueltos en una serie de \neventos misteriosos al tratar de encontrarlo.", 2016, "Mike Wheeler, Millie Bobby Brown, Noah Schnapp", 4, temposST);
		Pelicula pelicula5 = new Pelicula("Corre", 3, Genero.TERROR, Clasificacion.MAS13, "Dicen que el amor de una madre es eterno pero para Chloe no es un consuelo, sino una amenaza. \nHay algo extraño, incluso siniestro en la relación de ella y su madre, Diane.", 2021, "Sarah Paulson, Kiera Allen, Pat Healy", "1:29");
		Pelicula pelicula6 = new Pelicula("Terror en Silent Hill", 4, Genero.TERROR, Clasificacion.MAS13, "Sin poder aceptar el hecho de que su hija se está muriendo, Rose decide llevar a la niña con un curandero. \nDurante el camino, las dos viajan a través de un portal que las conduce a un misterioso pueblo llamado Silent Hill.", 2006, "Radha Mitchell, Sean Bean, Laurie Holden", "2:05");
		Pelicula pelicula7 = new Pelicula("Ted", 3, Genero.COMEDIA, Clasificacion.MAS13, "Cuando John Bennett era un niño pequeño, pidió el deseo de que Ted, su querido oso de peluche, cobrara vida. Treinta años más tarde, Ted continúa siendo el compañero de John, ante el disgusto de Lori, la novia de John.", 2012, "Mark Wahlberg, Mila Kunis, Seth MacFarlane", "1:46");
		Pelicula pelicula8 = new Pelicula("La Mascara", 5, Genero.COMEDIA, Clasificacion.MAS7, "Un aburrido empleado de banca encuentra una máscara que representa a Loki, un dios de la malicia y la travesura, la cual le transformará por completo.", 1994, "Jim Carrey, Cameron Diaz,Peter Riegert", "1:41");
